...
app.post('/doInsert', async function(req, res) {
    ...
    if (Category != 'Sach' && Category != 'Lego') {
        res.render("insert", { msg: 'Category: Sach or Lego' });
    } else {
        const newProduct = { name: Name, price: Price, description: Description, category: Category };
